    ...
    return (
        <CardTable title={"Personal Info"}>
                    ...
                    <div className="flex justify-center items-center">
                        ...
                        <div className="image-input size-16">
                            ...
                            <div
                                ...
                                <img src="#" alt="avatar"/>
                                <div
                                    className="flex items-center justify-center cursor-pointer h-5 left-0 right-0 bottom-0 bg-dark-clarity absolute z-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="12"
                                         viewBox="0 0 14 12" className="fill-light opacity-80">
                                        <path
            ...
            <CardTableRow
                ...
                action={<a href="#" className="btn btn-sm btn-icon btn-clear btn-primary"><i
                    className="ki-filled ki-notepad-edit"></i></a>}
            />
