    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <section className="mt-6 mb-4">
                ...
                <p>
                    This Data Processing Agreement ("DPA") is entered into between LEXRAG PTE. LTD. ("LEXRAG," "we," "our," or "us")
                    and the user ("Data Controller") to outline the terms governing the processing of personal data under the
            ...
            <section className="mb-4">
                ...
                <ul className="list-disc pl-6">
                    ...
                    <li><strong>Processing:</strong> Any operation performed on personal data, including collection, storage, transfer, and deletion.</li>
                    <li><strong>Data Controller:</strong> The entity that determines the purposes and means of processing personal data.</li>
                    <li><strong>Data Processor:</strong> LEXRAG, processing personal data on behalf of the Data Controller.</li>
                </ul>
            </section>
            ...
            <section className="mb-4">
                ...
                <ul className="list-disc pl-6">
                    <li><strong>Bitrix24:</strong> For customer data management (name, email, phone number).</li>
                    <li><strong>Stripe:</strong> For payment processing.</li>
                    <li><strong>Hosting Providers:</strong> Secure data storage and infrastructure services.</li>
                </ul>
            </section>
            ...
            <section className="mb-4">
                ...
                <ul className="list-disc pl-6">
                    ...
                    <li>Upon termination of service or request by the user, data will be deleted or anonymized unless legal obligations require otherwise.</li>
                </ul>
            </section>
            ...
            <section className="mb-4">
                ...
                <p>
                    If personal data is transferred outside Singapore, LEXRAG ensures compliance with PDPA data transfer requirements.
                </p>
            </section>
            ...
            <section className="mb-4">
                ...
                <p>
                    LEXRAG may update this DPA from time to time. Users will be notified of significant changes.
                </p>
            </section>
            ...
            <p className="mt-6">
                By using LEXRAG, you acknowledge that you have read, understood, and agreed to this Data Processing Agreement.
            </p>
        </div>
    );
}
