            ...
            >
                ...
                {showTooltip && (
                    <div
                        ...
                        style={{
                            backgroundColor: index === 4 ? '#06DF7299' : '#BBBCFA',
                            boxShadow:
                                index === 4 ? `0 0 20px rgba(6, 223, 114, 0.3)` : `0 0 20px rgba(187, 188, 250, 0.5)`,
                            padding: '16px',
                            marginBottom: '15px',
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{
                                ...
                                borderTop: index === 4 ? '12px solid #06DF7299' : '12px solid #BBBCFA',
                                marginTop: '-1px',
                            }}
                        />
                    </div>
