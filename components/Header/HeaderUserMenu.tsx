            ...
            <DropdownMenuContent align="end" sideOffset={6} className="w-[250px] p-0">
                <div className="flex items-center justify-between px-5 py-2 gap-2">
                    <div className="flex flex-col gap-0.5 overflow-hidden">
                        <Link href="#" className="text-sm text-gray-800 hover:text-primary font-semibold truncate">
                            {user?.first_name} {user?.last_name}
                        </Link>
                        <Link href="#" className="text-xs text-gray-600 hover:text-primary truncate">
                            {user?.email}
                        </Link>
                    </div>
