...
export const TrustedDeviceRow = ({ device }: TrustedDeviceRowProps) => {
    return (
        ...
        >
            <TableCell data-slot="table-cell" className="p-4 align-middle [&:has([role=checkbox])]:pe-0 min-w-48 w-48">
            ...
            <TableCell
                ...
                className="p-4 align-middle [&:has([role=checkbox])]:pe-0 min-w-56 text-secondary-foreground font-normal"
            >
                {device.os}
                <br />
