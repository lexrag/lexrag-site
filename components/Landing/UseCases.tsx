        ...
        <>
            ...
            <div className="bg-[#13263C] min-h-[60vh] py-10">
                <div className="text-center mb-10">
                    <h3 className="text-white text-2xl md:text-4xl mb-5 font-semibold">Use Cases</h3>
                    <p className="font-medium text-gray-400 dark:text-gray-400 transition-colors duration-300">
                        Power every legal task — from research to risk — with retrieval-augmented AI
                        <br />
                    </p>
                </div>
                    ...
                    {[
                        ...
                        >
                            ...
                            <div className="flex justify-center items-center mb-4">
                                <div className="text-lg font-semibold text-white dark:text-white">{item.title}</div>
                            </div>
