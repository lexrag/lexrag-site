        ...
        <>
            ...
            <div className="bg-[#13263C] min-h-[60vh]">
                <div className="text-center mb-10">
                    <h3 className="text-white text-2xl md:text-4xl pt-5 mb-5 font-semibold">We Simplify Your Work</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 lg:pr-[14%] lg:pl-[14%]">
                    {stats.map((stat, index) => (
                        ...
                        >
                            ...
                            <span className="text-gray-600 text-md text-center">{stat.label}</span>
                        </div>
                    ))}
                </div>
                ...
                <div className="text-md md:text-2xl font-semibold text-gray-500 text-center pt-5 pb-3">
                    ...
                    <br />
                    <span className="text-gray-700 mr-1">more powerful</span>, emotionally expressive way
                    <span className="text-4xl leading-none text-gray-700">“</span>
                </div>
            </div>
