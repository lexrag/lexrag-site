    ...
    return (
        <>
            <div className="text-center mb-10">
                <h3 className="text-2xl md:text-4xl mb-5 font-semibold">Our Great Team</h3>

                <p className="text-gray-600">
                    It’s no doubt that when a development takes longer to complete,
                    <br /> additional costs to integrate and test each extra feature creeps up and haunts most of us.
                </p>
