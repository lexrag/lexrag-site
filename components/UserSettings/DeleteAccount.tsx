    ...
    return (
        <CardWrapper title="Delete Account">
            <p className="text-sm text-foreground my-4">
                We regret to see you leave. Confirm account deletion below. Your data will be permanently removed. Thank
                you for being part of our community.
            </p>
            <div className="flex items-center gap-2">
                <Checkbox id="delete-account" checked={isChecked} onCheckedChange={() => setIsChecked(!isChecked)} />
