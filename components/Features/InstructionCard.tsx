            ...
            <div className="grid md:grid-cols-1 gap-2">
                {features.map((feature, index) => (
                    <div key={index} className="flex items-start gap-3 pe-7.5">
                        <i className="ki-filled ki-check-circle text-base text-success text-midnight-core! mt-1" />
                        <div className="flex flex-col">
                            <span className="text-sm font-semibold text-midnight-core">{feature.title}</span>
