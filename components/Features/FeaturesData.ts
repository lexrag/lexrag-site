...
export const combinedFeaturesData: FeatureData[] = [
    {
        ...
        pageMetadata: {
            ...
            description:
                'Visualize your data in a graph format to better understand the relationships between different entities.',
        },
        deffinitionCardDetails: {
            subtitle: 'Definition',
            icon: 'ki-graph',
        ...
        instructionCardDetails: {
            ...
            description:
                'Visualize legal data in a graph format to better understand the relationships between different legal sources.',
        ...
        instructionCardFeatures: [
            {
                ...
                description:
                    'Larger nodes representing more influential laws or court cases, and color-coding for different legal areas',
            },
            {
                title: 'Clustering and Grouping',
                description:
                    'Spotting legal domains or thematic clusters (e.g., family law, corporate law) through graph segmentation',
            },
            {
            ...
            },
            {
                ...
                description:
                    'Visualization of legal chains showing the flow of influence from one decision or law to another',
            },
            {
                title: 'Anomaly and Outlier Visualization',
                description:
                    'Spotting isolated nodes or unexpected links that might indicate rare or unique legal cases',
            },
        ],
        ...
        instructionCardFeatures: [
            {
                ...
                description:
                    'Understand legal concepts through natural language processing for accurate search results.',
            },
            {
...

    {
        ...
        instructionCardDetails: {
            ...
            description:
                'Easily upload legal documents, analyze content, and integrate results with AI-assisted queries.',
            imgSrcLight: '',
            imgSrcDark: '',
            imgClassName: 'max-h-[350px]',
        },
...

    {
        ...
        pageMetadata: {
            ...
            description:
                "Unlock valuable insights into legal trends and patterns using Lexrag's Base Analytics feature.",
        },
        deffinitionCardDetails: {
            subtitle: 'Definition',
            icon: 'ki-chart-simple',
...

    {
        ...
        pageMetadata: {
            ...
            description:
                "Discover deep insights into court decision trends and sentiments using Lexrag's Judicial Analytics.",
        },
        deffinitionCardDetails: {
            subtitle: 'Definition',
            icon: 'ki-brifecase-tick',
...

    {
        ...
        pageMetadata: {
            ...
            description:
                "Analyze legislative trends, historical law changes, and their practical implications with Lexrag's Legislative Analytics.",
        },
        deffinitionCardDetails: {
            subtitle: 'Definition',
            icon: 'ki-chart',
        ...
        instructionCardDetails: {
            ...
            description:
                'Utilize data-driven insights to track legislative changes and their impact on society and industries.',
            imgSrcLight: '',
            imgSrcDark: '',
            imgClassName: 'max-h-[350px]',
        },
...

    {
        ...
        pageMetadata: {
            ...
            description:
                "Get a comprehensive view of legal trends and use advanced analytics to forecast outcomes with Lexrag's Full Analytics.",
        },
        deffinitionCardDetails: {
            subtitle: 'Definition',
            icon: 'ki-chart-pie-3',
        ...
        instructionCardDetails: {
            ...
            description:
                'Leverage integrated analytics to gain a complete understanding of legal trends and anticipate future changes.',
            imgSrcLight: '',
            imgSrcDark: '',
            imgClassName: 'max-h-[350px]',
        },
