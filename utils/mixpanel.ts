...
const MIXPANEL_TOKEN = 'f3df3a52d416f322ed3420db0a4ed4b3';
...
export const getUserId = async (): Promise<string | null> => {
    try {
        ...
        console.error('Error getting user ID for Mixpanel:', error);
    }
    return null;
};
...
export const getUserType = async (): Promise<string> => {
    try {
        ...
        console.error('Error getting user type for Mixpanel:', error);
    }
    return 'free';
};
...
export class MixpanelContentTimeTracker {
...
export const initializeMixpanelAnalytics = async () => {
    if (typeof window !== 'undefined') {
        initializeMixpanel();
...
export const mixpanelContentTimeTracker = new MixpanelContentTimeTracker();
