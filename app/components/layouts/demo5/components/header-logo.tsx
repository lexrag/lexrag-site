...
import { ChevronDown, Menu, Settings, Shield, UserCircle, Users, type LucideIcon } from 'lucide-react';
        ...
        <div className="flex items-center gap-1.5 lg:gap-5">
            ...
            {isMobile && (
                <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                    ...
                    <SheetContent className="p-0 gap-0 w-[250px]" side="left" close={false}>
            ...
            {!isMobile && (
                <div className="lg:flex items-stretch gap-3">
                    ...
                    <span className="text-sm text-muted-foreground font-medium px-2.5 md:inline">/</span>
                    ...
                    <span className="text-sm text-muted-foreground font-medium px-2.5">/</span>
