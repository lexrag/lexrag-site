    ...
    return (
        <Suspense>
            <div className="w-full space-y-6 max-w-sm mx-auto">
                <h3 className="text-lg font-medium text-center m-3">Check your email</h3>
                <div className="text-2sm text-center text-gray-700 mb-7.5">
                    Please enter the verification code sent to your email&nbsp;
                    <a href="#" className="text-2sm font-medium hover:text-primary-active">
                        {email}
                    </a>
                    <br />
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                        ...
                        <Button type="submit" disabled={isProcessing} className="w-full">
                            {isProcessing && <LoaderCircleIcon className="animate-spin mr-2 h-4 w-4" />}
                            Verify
                        </Button>
