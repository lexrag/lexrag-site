    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <section className="mt-6 mb-4">
                ...
                <p>
                    LEXRAG PTE. LTD. ("LEXRAG," "we," "our," or "us") is committed to protecting your privacy.
                    This Privacy Policy explains how we collect, use, disclose, and protect your personal data when
                    you access our legal AI assistant services through our website{" "}
            ...
            <section className="mb-4">
                ...
                <p><strong>Data Protection Officer:</strong> Aleksandr Khazov</p>
            </section>

            <section className="mb-4">
                <h2 className="text-xl font-semibold">3. Personal Data We Collect</h2>
                <ul className="list-disc pl-6">
                    <li><strong>User Account Information:</strong> Name, email address, phone number.</li>
                    <li><strong>Payment Information:</strong> Processed securely through Stripe; we do not store payment details.</li>
                    <li><strong>Usage Data:</strong> Information about how you interact with our Service (e.g., logins, activity logs, device information).</li>
                    <li><strong>Cookies & Tracking Data:</strong> Details on cookies are outlined in our <a href="#" className="text-blue-500 underline">Cookie Policy</a>.</li>
                </ul>
            </section>
            ...
            <section className="mb-4">
                ...
                <ul className="list-disc pl-6">
                    ...
                    <li>To comply with legal obligations under Singapore’s <strong>Personal Data Protection Act (PDPA)</strong>.</li>
                </ul>
            </section>
            ...
            <section className="mb-4">
                ...
                <ul className="list-disc pl-6">
                    <li><strong>Bitrix24 CRM:</strong> For customer relationship management (includes name, email, and phone number).</li>
                    <li><strong>Payment Processors (Stripe):</strong> To facilitate secure transactions.</li>
                    <li><strong>Legal & Regulatory Authorities:</strong> If required by law or legal process.</li>
                </ul>
            ...
            <section className="mb-4">
                ...
                <ul className="list-disc pl-6">
                    ...
                    <li><strong>Retention period:</strong> Data is retained as long as necessary to fulfill the purpose for which it was collected.</li>
                </ul>
            </section>
            ...
            <section className="mb-4">
                ...
                <p>
                    ...
                    settings in their browser. For more details, see our <a href="#" className="text-blue-500 underline">Cookie Policy</a>.
                </p>
            </section>
            ...
            <section className="mb-4">
                ...
                <p>
                    Your data may be processed outside Singapore, but we ensure compliance with PDPA data transfer regulations.
                </p>
            </section>
