    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <section className="mt-6 mb-4">
                ...
                <p>
                    LEXRAG PTE. LTD. ("LEXRAG," "we," "our," or "us") is committed to providing a high-quality legal AI
                    assistant service. This Refund & Cancellation Policy outlines the conditions under which users may
                    cancel their subscriptions and request refunds.
                </p>
            </section>
            ...
            <section className="mb-4">
                ...
                <ul className="list-disc pl-6">
                    <li>
                        Users may cancel their subscription at any time through their account settings on{' '}
                    ...
                    <li>
                        Upon cancellation, the subscription remains active until the end of the current billing cycle.
                    </li>
            ...
            <section className="mb-4">
                ...
                <ul className="list-disc pl-6">
                    <li>
                        <strong>14-Day Money-Back Guarantee:</strong> Users may request a full refund within 14 days of
                        the initial subscription purchase, provided they have not used the service.
                    </li>
                    <li>
                        <strong>Service Disruption:</strong> If the service was unavailable due to technical issues on
                        our end for an extended period (exceeding 48 hours), users may request a pro-rated refund.
                    </li>
                    <li>
                        <strong>Duplicate Charges:</strong> If a user is charged multiple times for the same
                        subscription due to a billing error, a full refund for the duplicate transaction(s) will be
                        issued.
                    </li>
                </ul>
            </section>
            ...
            <section className="mb-4">
                ...
                <ul className="list-disc pl-6">
                    ...
                    <li>
                        If the issue arises due to the user’s failure to meet technical requirements or maintain proper
            ...
            <p className="mt-6">
                By using LEXRAG, you acknowledge that you have read, understood, and agreed to this Refund &
                Cancellation Policy.
            </p>
        </div>
    );
