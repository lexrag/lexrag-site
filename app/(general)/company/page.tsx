                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                                To revolutionize legal research and analysis by leveraging cutting-edge GraphRAG technology, 
                                making complex legal information accessible, understandable, and actionable for legal professionals worldwide.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                                To become the global leader in AI-powered legal technology, transforming how legal professionals 
                                access, analyze, and utilize legal information through innovative graph-based solutions.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mb-20">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                                ...
                                <CardContent>
                                    <CardDescription>
                                        We're committed to making legal technology accessible to professionals 
                                        across different jurisdictions and legal systems.
                                    </CardDescription>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                                ...
                                <CardContent>
                                    <CardDescription>
                                        We maintain the highest standards of quality in our technology, 
